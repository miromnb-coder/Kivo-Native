...
const styles = StyleSheet.create({
  ...
  upgrade: { minHeight: 32, borderRadius: 999, backgroundColor: '#ececef', justifyContent: 'center', paddingHorizontal: 12 },
  upgradeText: { color: '#6c7078', fontSize: 12.6, fontWeight: '700' },
